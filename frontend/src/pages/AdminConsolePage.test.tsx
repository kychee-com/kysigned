...
describe('AdminConsolePage — Funnel tab (F-38.6)', () => {
  const summary = {
    ...
    by_method: { magic_link: [0, 0, 0, 0, 0, 0, 0, 1], google: [0, 0, 0, 0, 0, 0, 0, 2] },
  ...
  it('renders the eight steps in order with counts and the drop between adjacent steps', async () => {
    ...
    // F-41.5 (AC-250) — the sign-in method split renders beside the others.
    expect(screen.getByTestId('admin-funnel-methods')).toHaveTextContent('google');
